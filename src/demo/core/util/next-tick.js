...
function flushCallbacks () { // 依次执行fn list
  pending = false// 不需要等待了，下面代码已经执行了callbacks里面所有的fn，并且callbacks = []
...
if (typeof Promise !== 'undefined' && isNative(Promise)) {
  ...
  isUsingMicroTask = true
} else if (typeof setImmediate !== 'undefined' && isNative(setImmediate)) { // macrotask 任务
